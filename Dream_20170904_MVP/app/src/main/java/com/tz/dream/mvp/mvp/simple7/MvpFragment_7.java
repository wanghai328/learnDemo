...
import com.tz.dream.mvp.mvp.simple6.base.BaseView_6;
...
//集成MVP设计(父类:抽象部分)
public abstract class MvpFragment_7<V extends BaseView_6, P extends BasePresenter_6<V>> extends Fragment {
